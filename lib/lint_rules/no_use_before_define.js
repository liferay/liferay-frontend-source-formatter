...
module.exports = function(context) {
    ...
    function findVariables() {
        ...
        var typeOption = configuration.nofunc ? NO_FUNC : null;
        var scopeOption = configuration.samescope;

        function checkLocationAndReport(reference, declaration) {
            if ((typeOption !== NO_FUNC || declaration.defs[0].type !== "FunctionName") && (!scopeOption || reference.from.variableScope === declaration.scope)) {

...
re.prototype.getMessage = function(lineNum, item, result, rule, context) {
	var warning;
...
re.prototype._callReplacer = function(fullItem, result, rule, context) {
	var replacer = rule.replacer;
...
re.prototype._callFormatItem = function(fullItem, context) {

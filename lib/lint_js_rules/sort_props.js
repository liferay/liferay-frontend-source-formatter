...
module.exports = function(context) {
	...
	var getComputedPropertyName = function(obj) {
		return sourceCode.getTokenBefore(obj).value + sourceCode.getText(obj) + sourceCode.getTokenAfter(obj).value;
	};
	...
	var isFunctionExpression = function(obj) {
		return obj.type === 'FunctionExpression' || obj.type === 'ArrowFunctionExpression';
	};

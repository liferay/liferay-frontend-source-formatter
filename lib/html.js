...
Formatter.HTML = Formatter.create(
	{
		...
		prototype: {
			...
			_handleScriptletWhitespace: function(scriptBlock) {
			...
			_iterateJSRules: function(scriptBlock) {
				var instance = this;
			...
			_padJSLines: function(scriptBlock) {
			...
			_removeScriptletBlocks: function(scriptBlock) {
				var rescanBlocks = [];
			...
			sanitizeScriptBlocks: function(scriptBlocks) {
				...
				scriptBlocks = scriptBlocks.map(
					function(item, index) {
						...
						item = instance._iterateJSRules(item);
						item = instance._removeScriptletBlocks(item);
						item = instance._padJSLines(item);
						item = instance._handleScriptletWhitespace(item);

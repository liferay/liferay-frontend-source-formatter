...
exports.getLineDistance = function(left, right, leftEnd, rightStart) {
	return right.loc[rightStart || 'start'].line - left.loc[leftEnd || 'end'].line;
};
...
var startsWithUpperCase = exports.startsWithUpperCase = function(str) {
	return str[0] === str[0].toLocaleLowerCase();
};

exports.isConstructor = function(node) {
